...
class List extends Component {
    ...
    loadData(){
      ...
      const url = `/api/transporters?size=${this.state.size}&page=${this.state.page}&sort=${this.state.sortProperty},${this.state.sortDirection}`;      
      fetch(url)
    ...
    async remove(id) {
      await fetch(`/api/transporter/${id}`, {
        method: 'DELETE',
        headers: {
